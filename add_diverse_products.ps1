...
try {
    ...
    Write-Host "Created: Elegant High Heels (ID: $($heelsResponse.id)) - Icon: 👠" -ForegroundColor Green
} catch {
...
try {
    ...
    Write-Host "Created: Men's Formal Shoes (ID: $($shoesResponse.id)) - Icon: 👞" -ForegroundColor Green
} catch {
...
try {
    ...
    Write-Host "Created: Kids Colorful Sneakers (ID: $($kidsResponse.id)) - Icon: 👟" -ForegroundColor Green
} catch {
...
try {
    ...
    Write-Host "Created: Diamond Necklace (ID: $($jewelryResponse.id)) - Icon: 💍" -ForegroundColor Green
} catch {
...
try {
    ...
    Write-Host "Created: Designer Sunglasses (ID: $($sunglassesResponse.id)) - Icon: 🕶️" -ForegroundColor Green
} catch {
...
try {
    ...
    Write-Host "Created: Leather Fashion Belt (ID: $($beltResponse.id)) - Icon: 🔗" -ForegroundColor Green
} catch {
...
Write-Host "Men's Clothing | Women's Clothing | Kids' Clothing" -ForegroundColor White
Write-Host "Men's Footwear | Women's Footwear | Kids' Footwear" -ForegroundColor White
Write-Host "Bags | Jewelry | Watches | Belts | Sunglasses" -ForegroundColor White